...
public class RiskHistoryController {
    ...
    public ResponseEntity<JSONObject> getRiskHistoryById(@PathVariable Long id) throws ObjectDoesNotExist {
        if(riskHistoryService.getRiskHistoryById(id) == null) {
            throw new ObjectDoesNotExist("Risk History with that ID does not exist");
        }
    ...
    public ResponseEntity<JSONObject> deleteRiskHistoryById(@PathVariable Long id) throws ObjectDoesNotExist {
        if(riskHistoryService.getRiskHistoryById(id) == null) {
            throw new ObjectDoesNotExist("Risk History with that ID does not exist");
        }
