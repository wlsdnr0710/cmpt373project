...
public interface ClientRepository extends JpaRepository<Client, Long> {
    ...
    Page<Client> findBycbrWorkerIdContaining(Pageable pageable, Long cbrWorkerId);
    Page<Client> findByzoneContaining(Pageable pageable, String zone);
    Page<Client> findByvillageNumberContaining(Pageable pageable, int villageNumber);
}
